...
<body class="gradient-bg min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="text-center mb-8">
            <div class="bg-white w-20 h-20 rounded-full mx-auto mb-4 flex items-center justify-center shadow-lg overflow-hidden">
                <img src="<?= asset('img/logo.png') ?>" alt="Logo" class="w-16 h-16 object-contain">
            </div>
            <h1 class="text-3xl font-bold text-white mb-2">Vildan Portal</h1>
            <p class="text-indigo-100">Vildan Koleji Bilgi Sistemine Hoş Geldiniz!</p>
        </div>
            ...
            <form method="POST" action="<?= url('/login') ?>" class="space-y-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input 
                            ...
                            id="username" 
                            required
                            class="block w-full pl-10 pr-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-600 focus:border-transparent"
                            value="<?= old('username') ?>"
                        >
                    </div>
                </div>
                ...
                <?php if ($google_enabled ?? false): ?>
                    ...
                    <a 
                        ...
                        class="w-full flex items-center justify-center gap-3 bg-white border border-gray-300 text-gray-700 py-3 px-4 rounded-lg font-medium hover:bg-gray-50 transition duration-150"
                    >
