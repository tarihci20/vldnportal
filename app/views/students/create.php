...
<div id="alertContainer" class="mb-4">
    <?php $flash = getFlashMessage(); if ($flash): ?>
        <div class="p-4 rounded-lg <?= $flash['type'] === 'success' ? 'bg-green-100 text-green-800 border border-green-300' : 'bg-red-100 text-red-800 border border-red-300' ?>" role="alert">
            <div class="flex items-center">
...
<div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
    <form id="studentForm" method="POST" action="<?= url('/students/store') ?>" class="p-6">
        ...
        <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-200 dark:border-gray-700">
            <a
                href="<?= url('/students') ?>"
                class="text-white bg-gray-600 hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 border border-gray-600 shadow"
            >
