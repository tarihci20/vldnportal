...
<!-- Main Content -->
        ...
        <!-- Page Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">Öğrenci Düzenle</h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                <?= esc($student['first_name'] . ' ' . $student['last_name']) ?> - <?= esc($student['class']) ?>
            </p>
        </div>
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-md">
            <form id="studentForm" method="POST" action="<?= url('/students/' . $student['id']) ?>" class="p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                id="father_phone" 
                                name="father_phone" 
                                value="<?= esc($student['father_phone']) ?>"
                                maxlength="11"
                                pattern="0[0-9]{10}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                            >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                id="mother_phone" 
                                name="mother_phone" 
                                value="<?= esc($student['mother_phone']) ?>"
                                maxlength="11"
                                pattern="0[0-9]{10}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                            >
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                id="teacher_name" 
                                name="teacher_name" 
                                value="<?= esc($student['teacher_name']) ?>"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                            >
                        </div>
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                id="teacher_phone" 
                                name="teacher_phone" 
                                value="<?= esc($student['teacher_phone']) ?>"
                                maxlength="11"
                                pattern="0[0-9]{10}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                            >
                ...
                <!-- Form Buttons -->
                <div class="flex items-center justify-end space-x-4 pt-6 mt-6 border-t-2 border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 -m-6 mt-6 p-6 rounded-b-lg">
                    <a 
                        href="<?= url('/students/' . $student['id']) ?>" 
                        class="text-gray-700 bg-white hover:bg-gray-100 border border-gray-300 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-6 py-3 dark:bg-gray-600 dark:text-white dark:hover:bg-gray-700 transition"
                    >
                        <i class="fas fa-times mr-2"></i> İptal
                    </a>
                    <button 
                        type="submit" 
                        class="text-white bg-indigo-600 hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-300 font-medium rounded-lg text-sm px-6 py-3 shadow-lg transition"
                    >
                        <i class="fas fa-save mr-2"></i> Kaydet ve Güncelle
                    </button>
                </div>
